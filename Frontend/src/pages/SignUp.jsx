...
function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        // Display alert and navigate to the login page
    ...
    <div className="flex items-center justify-center min-h-screen bg-transparent">
      <div className="w-full max-w-xs p-6 bg-white rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-right py-2"><p>If you have Account? <Link to="/Login" className="text-blue-700">Login</Link></p></div>
        </form>
      </div>
    </div>
  );
